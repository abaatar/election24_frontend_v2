...
import PinkTable from "@/components/pink/PinkTable";
...
const Pinks = () => {
  ...
  const getCallback = useCallback(async () => {
    ...
    try {
      const resp = await PinkServices.getAllPinks(q);
      return resp;
    } catch (err) {
  ...
  return (
    <>
      ...
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title="Selected Pink" />
      <BulkActionDrawer ids={allId} title="Pinks" />
