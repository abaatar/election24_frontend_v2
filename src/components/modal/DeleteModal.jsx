  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (location.pathname === "/pinks") {
        if (ids) {
          const res = await PinkServices.deleteManyPinks({
            ids: ids,
          });
          setIsUpdate(true);
          notifySuccess(res.message);
          ...
          const res = await PinkServices.deletePink(id);
          setIsUpdate(true);
          notifySuccess(res.message);
          setServiceId();
          closeModal();
      ...
      if (location.pathname === "/influence") {
        if (ids) {
          const res = await PenServices.deleteManyPens({
            ids: ids,
          });
          setIsUpdate(true);
          notifySuccess(res.message);
          ...
          const res = await PenServices.deletePen(id);
          setIsUpdate(true);
          notifySuccess(res.message);
          setServiceId();
          closeModal();
